...
namespace Lavanderia.Domain.Interfaces.Repository
{
    public interface IRepository<TEntity> where TEntity : class
    {
        ...
        Task<PagedList<TEntity>> FindAllAsync(DefaultParameters ownerParameters, CancellationToken ct = default);
        Task<IEnumerable<TEntity>> FindByAsync(Expression<Func<TEntity, bool>> predicate, CancellationToken ct = default);
